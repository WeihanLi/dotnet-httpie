...
RUN dotnet publish -f net7.0 -c Release --use-current-runtime --sc -p:PublishSingleFile=true -p:EnableCompressionInSingleFile=true -p:AssemblyName=http -p:TargetFrameworks=net7.0 -o /app/artifacts
